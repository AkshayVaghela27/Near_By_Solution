    ...
    <div className=" bg-slate-300 rounded-xl drop-shadow-2xl justify-self-center w-full relative overflow-hidden">
      <a href="#" className="group relative block bg-black">
        ...
        <div className="relative p-4 sm:p-6 lg:p-8">
          ...
          <div className='flex justify-between justify-items-center'><span className='text-sm font-bold text-white'>6kms away</span> <a href="#" class="inline-flex drop-shadow-2xl items-center px-3 py-2 text-sm font-medium text-center text-white bg-black rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 ">
            Get directions
