...
const SearchService = () => {
  return (
    <div className="w-4/5  mx-auto ">
      ...
      <div >
            <input type="text" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg my-2 focus:ring-blue-500 focus:border-blue-400 block w-4/5  p-2.5 " placeholder="Search for services / products" required />
        </div>
         </div>
